    ...
    <View style={container}>
      ...
      <View style={{flexDirection: 'row-reverse', margin: 15 }}>
        ...
        <TouchableOpacity onPress={()=>Validate()} style={styles.button}>
          <Text style={{ justifyContent: 'center', alignContent: 'center', margin: 10, marginRight: '40%'}}>כניסה </Text>
      </TouchableOpacity>
      <TouchableOpacity onPress={()=>navigation.navigate("Register")} style={styles.button}>
          <Text style={{ justifyContent: 'center', alignContent: 'center', margin: 10, marginRight: '35%'}}>הרשמה </Text>
      </TouchableOpacity>
      </View>
